...
colnames(Results) <- c("Month", "TMINSlope", "TMIN_P", "TMINRsq", "TMAXSlope", "TMAX_P", "TMAXRsq", "starTMAX", "starTAVG", "TMIN Slope", "TMAX Slope")
...
library(knitr)
kable(Results[,c(1, 10,11)], rownames=FALSE, type = "html")
