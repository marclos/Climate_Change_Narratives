...
\section*{Specifics Crop Types}

\QItem{ \Qq{What type of systems are you most interested? (Check at least 5.)}
\begin{Qlist}
  \item Corn Belt (Corn-Soybean Rotation)
  \item No-till corn
  \item Wheat and Grasslands
  \item Potatoes, Wetlands, and Klammath Wildlife Refuge
  \item Berries and Discrolls
  \item Florida's vegetables productions
  \item Yuma and Salinas and Leafy Greens
  \item Rice in the Mississippi River basin
  \item Bison and grassland restoration
  \item Mexico's traditional Maize systems
  \item Shade Coffee
  \item Palm Oil food products and energy
  \item Integrated dairy-corn farms
  \item Organic cotton
  \item Grass-fed beef
  \item Almonds
  \item Processed tomatoes
  \item Wine grapes
