...
<<echo=T>>=
set.seed(444) 
rnumbers = matrix(sample(10000:99999, 5* enrollment), 
...
print(xtable(enrolled[,c(3, 2, 5:9)], caption='Random Numbers for EA30, Fall 2020', label='tbl:numbers'), scalebox=1.0, caption.placement = "top")
@
