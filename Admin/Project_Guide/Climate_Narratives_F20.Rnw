...
\noindent where X is your surname.
...
studentA = c("Marc", "Christina", "Viviana", "Jacob", "Olivia", "Anna", "Nikodem")
studentB = c("--", "Lila", "Bryan", "Claire L", "Owen", "Melia", "Emma")
studentC = c("--", "Sarah", "Nora", "Tramy", "Claire M", "Katy", "Isabel") 
presentDate =c("09/12/20", "09/12/20", "09/12/20", "09/12/20", "09/12/20", "09/12/20", "09/12/20")
