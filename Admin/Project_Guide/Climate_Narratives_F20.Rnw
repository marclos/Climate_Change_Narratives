...
Op-Ed \#1                   & Aug 28    & Sep 12    & 10 \\
Draft Regional Analysis     & Sep 1   & Sep 12   & 20 \\
Draft Blog Template         & Sept 4    & Sept 19   & 5 \\
Climate Science Expert Team Video & Sep 1   & Sep 12   & 20 \\
Climate Science Expert Team Video -- Forum    & Sep 1  & Sep 19     & 15 \\

Regional Climate Literature Review    & Sep 1   & Sep 19   & 20 \\
%Regional Climate Literature Review -- Peer Review & Oct 1   & Oct 3 & 10 \\

Blog Draft                  & Sep 1   & Sep 26    & 50 \\
...
The assignment is pretty simple. Can you create an Rmd file, with your title and name as the author, some text of what you are going to be writing about, one image, and a simple plot. 

Push the Rmd and html file into github and name the file with your last name. 
...
studentA = c("1", "2", "3", "4", "5", "6", "7")
studentB = c("8", "9", "10", "11", "12", "13", "14")
studentC = c("15", "16", "17", "18", "19", "20", "21") 
presentDate =c("09/19/20", "09/19/20", "09/19/20", "9/19/20", "09/19/20", "09/19/20", "09/19/20")
project1teams <- data.frame(Topic = team, Team_Members = paste(studentA, ", ", studentB, ", ", studentC), Presentation_Date=presentDate)
print(xtable(project1teams), include.rownames=FALSE)
@

\subsection{Climate Science Review Presentation}

\input{Climate_Science_Presentation_F20}

%\subsection{Climate Science Review}

%\input{Climate_Science_Review_F20}

\subsection{Climate Science Presentation Forums}

\input{Climate_Science_Presentation_Forums_F20}
...
\input{Regional_Data_Analysis_F20}

\subsection{Regional Climate Impacts -- Literature Review}

\input{Regional_Impact_Literature_Review_F20}
...
%\input{Writing_a_Scientific_Blog_F20}

\subsection{Peer Review Blogs}

Coming soon! \smiley{}

%\input{Blog_Peer_Review_F20}

\subsection{Publishing Revised Blog}

Coming soon! \smiley{}

%\input{Blog_Publication_F20}
