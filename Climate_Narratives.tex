...
\subsection{Goals of this Documents}

1. Describe the goals and approach for the project

2. Provide or point to resources to prepare for and conduct the project

3. Describe how we will evaluate the projects.
...
\hlstd{tmp1} \hlkwb{<-}\hlstd{tmp1[ ,} \hlopt{!}\hlstd{(}\hlkwd{names}\hlstd{(tmp1)} \hlopt{%in%} \hlstd{drops)]}
...
## 20000 KGGI NA 41.717 NA -92.700 NA 307.2 NA 20060831  NA 20160629
\end{verbatim}
\begin{alltt}
