...
```{r}
HAGERSTOWN MD US <- subset(import, STATION_NAME=="HAGERSTOWN MD US", select=c(STATION, STATION_NAME, DATE, NewDate, TMIN, TMAX, PRCP))
```


## A new plot
```{r}
plot(TMAX~NewDate, HAGERSTOWN MD US, ty='l')
```
