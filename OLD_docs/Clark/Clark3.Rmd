...
TMAXresult <- NA
for (i in 1:12){
#plot(TMAX ~ YEAR, data = MonthlyTMAXMean[MonthlyTMAXMean$MONTH ==i, ], ty = "l", las = 1, xlim = c(1945, 2020),main = Months[i])
...
#plot(TMAX~YEAR, data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="10",],ty='l', xlim=c(1945, 2020))
Oct.lm <- lm(TMAX~YEAR, data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="10",])

#abline(coef(Oct.lm), col="red")
#plot(TMIN~YEAR, data=MonthlyTMINMean[MonthlyTMINMean$Month=="02",],ty='l', xlim=c(1945, 2020))
...
```{r picture1, echo=FALSE, fig.width = 4}
