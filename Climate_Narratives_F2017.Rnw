...
\begin{itemize*}
  ...
  \item \href{https://github.com/marclos/Climate_Change_Narratives/raw/master/Admin/Critical_Thinking.pdf}{``Critical Thinking in EA''}
\end{itemize*}
...
\input{Admin/Assignments/Op-Ed_F17-2}
