...
PRCPresult <- rbind(PRCPresult, 
  ...
  plot(PRCP~YEAR,data=Month_sub_DF, type='l', ylab='Precipitation', xlab='Years',main=Months[i], bty="L", las=1) 
  abline(coef(MonthMin_lm),col="pink") 
 }
```
