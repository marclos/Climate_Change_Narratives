...
```
Based on my analysis, my data indicate that there is a trend of decreasing snowfall in Salt Lake City for the month of January(slope = -0.0488, r2 = 0.2271, p-value = 0.02).
```{r Jan Snowfall}
i <- 1
