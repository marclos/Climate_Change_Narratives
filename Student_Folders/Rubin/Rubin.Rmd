...
![Windmill farm in Pidgeon, MI. Source: Shutterstock](Climate_Change_Narratives/Student_Folders/Rubin/Rubin_files/metrodetroitmichigan.jpg)
...
In order to analyze the impacts of climate change on the state of Michigan, this blog will center around the analysis of climate data including minimum and maximum daily temperatures and precipitation levels in Ann Arbor, Michigan, from the October 1st of 1891 to September 2nd of 2020.  Statistical support in the form of graphs for this hypothesis are based on data curated by the National Oceanic and Atmospheric Administration (NOAA), which was collected at the University of Michigan in Ann Arbor, and data from the National Agricultural Statistics Service (NASS_. This freely available data can be analyzed for various trends using R (National Oceanic and Atmospheric Administration 2020; National Agricultural Statistics Service 2020). Close analysis of trends and patterns in this information, along with the review of other research done in the region, informed the conclusions which will be presented in this blog. It should be noted that we will be focusing on Ann Arbor data to paint a general picture of weather anomalies in the whole state of Michigan, but total state data for agricultural trends.
