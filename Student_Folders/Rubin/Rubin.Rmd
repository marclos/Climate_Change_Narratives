...
*Historical prosperity of land users - small farmers and Indigenous peoples share landscape
...
plot(corn_bushels_per_acre$Value~corn_bushels_per_acre$Year, corn_bushels_per_acre, main="Corn Production in Bushels per Acre over Time", ylab= "Bushels per Acre", xlab="Year")
...
# Excellent decreasing, Poor increasing -- neither statistically significant
```{r corn_condition_excellent}
...
plot(newValue_exc~newYear_exc, main="Corn Condition (excellent) over Time", ylab= "Bushels per Acre", xlab="Year")
...
newValue_poor <- c(sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2020")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2019")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2018")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2017")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2016")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2015")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2014")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2013")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2012")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2011")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2010")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2009")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2008")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2007")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2006")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2005")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2004")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2003")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2002")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2001")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "2000")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1999")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1998")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1997")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1996")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1995")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1994")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1993")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1992")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1991")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1990")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1989")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1988")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1987")]), sum(corn_condition_poor$Value[which(corn_condition_poor$Year == "1986")]))
...
#cornconditionexc.lm <- lm(newValue_poor~newYear_poor)
#abline(coef(cornconditionexc.lm), col="red")
#summary(cornconditionexc.lm)
```

```{r total_corn_planted}
