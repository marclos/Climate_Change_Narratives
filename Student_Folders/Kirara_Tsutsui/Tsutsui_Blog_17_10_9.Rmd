...
Harvey struck the southeastern part of Texasthe most. According to remote sensing by the Dartmouth Flood Observatory, more than 3,800 square miles were flooded, an area nearly as large as Delaware and Rhode Island combined. 
...
#So What Does Hurricane Harvey Tell Us? 
...
The two proxies used in this study is Monthly Minimum Temperature figures over the (insert years here) and Monthly Total Precipitation figures. These figures are shown in graphs and the original data is obtained through the National Oceanic and Atmospheric Administration (NOAA). 
