...
To analyze the data, I read and interpreted the p and adjusted r2 values to ultimately test this null hypothesis: the air temperature of Los Angeles is increasing in correlation with time and dependent upon time. The significance of the p value and r2 value depends on how high the values are. In an effort to further the scope of my study, I accessed multiple peer review journals for the information about heat mitigation and impact studies. Results are significant if there is at least one * next to the slope value; this means that the p-value is less than .05 and one can reject the null hypothesis. NS means that there is no significance.
...
str(MonthlyTMINMean)
plot(TMIN~Year.num, data=MonthlyTMINMean[MonthlyTMINMean$Month=="08",], xlim=c(1906, 2014), xlab="Year", ylab="Minimum Temperatures", pch=19, cex=0.5, col="red")     
...
str(MonthlyTMAXMean)
plot(TMAX~Year.num, data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="08",], xlim=c(1906, 2014), xlab="Year", ylab="Maximum Temperatures", pch=19, cex=0.5, col="red")     
