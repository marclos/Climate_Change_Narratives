...
# January & 0.0068 NS & 0.016 & -0.0027 NS & 0.002 \\ 
# 2 & February & 0.0177 ** & 0.095 & 0.006 NS & 0.01 \\ 
# 3 & March & 0.0131 * & 0.061 & -0.0043 NS & 0.006 \\ 
# 4 & April & 0.0224 *** & 0.282 & 0.0051 NS & 0.02 \\ 
# 5 & May & 0.0199 *** & 0.343 & 0.0011 NS & 0.002 \\ 
# 6 & June & 0.0178 *** & 0.316 & 0.0031 NS & 0.01 \\ 
# 7 & July & 0.0159 *** & 0.362 & 0.0015 NS & 0.006 \\ 
# 8 & August & 0.0175 *** & 0.41 & 5e-04 NS & 0 \\ 
# 9 & September & 0.019 *** & 0.392 & 0.0045 NS & 0.026 \\ 
# 10 & October & 0.0208 *** & 0.219 & 0.0073 * & 0.039 \\ 
# 11 & November & 0.0208 *** & 0.15 & 0.0042 NS & 0.012 \\ 
# 12 & December & 0.0267 *** & 0.153 & 0.0113 * & 0.04 \\
