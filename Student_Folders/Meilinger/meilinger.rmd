...
![](https://www.ncdc.noaa.gov/EdadsV2/api/ASOSStationPhotos/image/byhash/DE057C49AB3E1D5A61E2376C5ED947AA){width=50%}

<!-- take eval=false out when wish to run code in knit -->
```{r "/home/CAMPUS/smac2019/Climate_Change_Narratives/Data/FA20/Sarah_Orlando_Data.csv", echo=FALSE, eval=FALSE}
...
```
## Temperature Risings
The amount that Florida's temperatures will drop every day has been decreasing, as shown here by a graph of August's minimum temperature from 1892 to the present. August’s minimum temperatures have been rising at a rate of **balh** per year for the past century. This correlation is scientifically very significant, at a confidence of greater 99.99% (with a p value of >.001).
