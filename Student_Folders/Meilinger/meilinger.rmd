...
For example, January has the least significant correlation between temperature minimums and the year. It still has an upward trend of 0.68 degrees celsius per century, which, while not necessarily as incredibly alarming (especially at its 79% confidence inerval) is still an unsustainable figure. 
