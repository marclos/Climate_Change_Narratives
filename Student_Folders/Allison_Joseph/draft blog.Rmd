...
climate_data <- read.csv("Climate_Change_Narratives/Student_Folders/Allison_Joseph/ally_tor.csv") 
...
## What does this mean for Torrance?
  ...
  However, in the past 15 years, mean sea level in California has remained relatively constant. It has been suggested that this suppression may have been associated with the Pacific Decadal Oscillation (PDO), a pattern of Pacific climate variability that alternates between multidecadal-long warm and cool ocean phases. Since mid-2014, the PDO is shifting back to its warm phase, which will likely allow for accelerated sea level rise along the West Coast.
