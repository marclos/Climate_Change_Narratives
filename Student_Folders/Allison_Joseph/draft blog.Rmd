...
This lack of nighttime cooling has characterized recent heat waves in California, increasing the duratuin of such extremem events to 5 days or longer. This places huge strains on California health and infrastructure.

## What does this mean for Torrance?

It was difficult to find literature on the issues plaguing Torrance in particular. Yet, as a part of the greater Los Angeles county, Torrance can serve as a model for other Los Angeles coastal cities facing climate change.
...
In brief, sea level rise poses a threat to Torrance's economic, social and environmental wellbeing. 
...
Sea level rise could also lead to a loss of public access and recreational opportunities due to permanent inundation, periodic flooding, or erosion of beaches, recreational areas, or trails. In areas where beaches cannot migrate inland due to development or more resistant landforms, beaches will become narrower or will disappear completely (California Coastal Commission, 2017). 

An analysis of 51 public beaches in Los Angeles County and Orange County evaluated the economic impacts of permanent beach loss caused by sea level rise and temporary beach inundation by extreme coastal storms. The study integrated a beach attendance model and a beach sediment model to predict that a 1 meter sea level rise by 2100 can reduce more than 500 thousand beach visits by Southern California residents each year, resulting in an economic loss of $40 million to $63 million annually. In addition, severe wind storms can also reduce beach attendance by more than 300 thousand, resulting in a $37 million economic loss  (Finkl, 2016). 
...
## Social Impacts
In addition, continued access to the coast is important to the health and well-being of the public, as people’s safety, lives, daily movement patterns, and sense of community and security can be disrupted.  The coast provides low-cost, outdoor recreation that can improve the overall quality of life for general public. 
  In addition, due to current development patterns along the coast, sea level rise and flooding will have disproportionate impacts on communities with the least capacity to adapt, deepening existing environmental injustice if adaptation responses are not managed effectively (City of Torrance, 2017). 
