...
=======
>>>>>>> 306898381292d63d25a985aff00173c92e376235
...
![View Jefferson Memorial](WAshington DC Image Jefferson Memorial.jpg)
...
file.path = "/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Data/FA20/JacobGreene_WashingtonDC_Data.csv"
...
points(TMIN~YEAR, data = MonthlyTMINMean[MonthlyTMINMean$Month=="09",], pch=19, cex=0.5, col="green")
SepTMIN.lm <- lm(TMIN~YEAR, data = MonthlyTMINMean[MonthlyTMINMean$Month=="09",])
abline(coef(SepTMIN.lm),col= "green",lwd=2)

points(TMIN~YEAR, data = MonthlyTMINMean[MonthlyTMINMean$Month=="05",], pch=19, cex=0.5, col="blue")
MayTMIN.lm <- lm(TMIN~YEAR, data = MonthlyTMINMean[MonthlyTMINMean$Month=="05",])
abline(coef(MayTMIN.lm),col= "blue",lwd=2)
...
![Map of high tide lines for Washington DC based off a global rise in four or two degrees celcius](Map of high tide DC.jpg)
