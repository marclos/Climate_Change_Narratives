...
---
Here is a draft of what my blog may look like!
...
Even though the slope on the temperature maximum graph is actually decreasing (meaning DC has gotten cooler), this correlation only has a p- value of .7895 which means that it is not significant.
