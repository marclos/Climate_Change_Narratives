...
## daily feb
dailyTMIN2015<-subset(climate_data, Month=="02" & Year=="2015")
...
MonthlyTMINMean$Year.num=as.numeric(MonthlyTMINMean$Year)
MonthlyTMINMean$Month.num=as.numeric(MonthlyTMINMean$Month)
plot(TMIN~Year.num, data=MonthlyTMINMean[MonthlyTMINMean$Month=="11",],ty='p',pch=20, xlim=c(1990,2020), main="November",xlab="Year", ylab="Temperatures in °C", ylim=c(-6,10))
points(TMIN~Year.num, data=MonthlyTMINMean[MonthlyTMINMean$Month=="02"&MonthlyTMINMean$Year==2019,],col="blue",pch=20, cex=1.5)
November.lm <- lm(TMIN~Year.num, data=MonthlyTMINMean[MonthlyTMINMean$Month=="11",])
November.2019 <- lm(TMIN~Year.num, data=MonthlyTMINMean[MonthlyTMINMean$Month=="11"&MonthlyTMINMean$Year!=2019,])
abline(coef(November.lm), col="red")

## daily Noc
dailyTMIN2019<-subset(climate_data, Month=="11" & Year=="2019")
plot(TMIN~Day, data=dailyTMIN2019, ty='p', main="November Minimum Temperatures in 2019", xlab="Day", ylab = "")
points(TMIN~Day, data=dailyTMIN2019,col="blue",pch=20, cex=1.5)
```
