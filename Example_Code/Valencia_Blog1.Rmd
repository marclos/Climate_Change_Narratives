...
#### Introduction
START TALKING ABOUT TEXAS Alvin, a small city in the Houston metropolitan area of Texas, is home to a weather station that has collected data since 1898, longer than any other weather station in Western Texas. 

The data, available online through the National Oceanic and Atmospheric Adminsitration (NOAA), can be helpful in analyzing local weather and climate trends in nearby Houston and Galveston.WHAT WEATHER TRENS, WHAT DOES TEMP AFFECT
...
```
#### Hypotheses
Following scientific protocol, we have come up with these hypotheses blah blah
...
p value is a rejection of the null hypothesis. what does this mean, this is an arbitrary number, reduces chance. nu
...
As shown above, the mean monthly temperatures from 1960-2013 are still increasing. With a p-value of 0.6986 we cannot reject or support the hypothesis. However, looking at the graph from 1970 on shows us that the increasing trend of temperatures persists regardless of the missing data. 
