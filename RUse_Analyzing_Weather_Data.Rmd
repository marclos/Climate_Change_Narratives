...
NOAA has a list of sites in the [isd-history](ftp://ftp.ncdc.noaa.gov/pub/data/noaa/isd-history.txt) , but I have not investigated the source of the data.
...
## GHCN Data -- Available Upon Request
...
But the file required some pre-processing, in particular, they were highly compressed.
...
Guides to create a Shiny App will be explored with another resource.
