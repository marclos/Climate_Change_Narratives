...
```{r}
poughkeepsie <- subset(import, STATION_NAME=="POUGHKEEPSIE NY US", select=c(STATION, STATION_NAME, DATE, NewDate, TMIN, TMAX, PRCP))
...
mean(poughkeepsie$PRCP)

plot(PRCP~NewDate, data=poughkeepsie)
