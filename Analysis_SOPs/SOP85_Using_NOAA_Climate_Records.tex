...
The first step to getting your data into R is to upload it into the the Rstudio server online.
Once you are in Rstudio you will want to locate a good folder/location in the Rstudio directory to which to upload your data file. We suggest uploading 
