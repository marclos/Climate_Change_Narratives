...
\hlstd{file} \hlkwb{=} \hlstr{"/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Data/Singapore_ClimateData.csv"}
...
We need to ensure the that imported file is what you expected and that it read the csv file correctly. There are several ways to accomplish this. We can plot the data, inspect the first few observations, or look at the structure of the dataframe. 

We will do all of the these below.
