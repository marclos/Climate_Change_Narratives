...
\section{Understanding the Data: The First Step of Data Analysis}
...
\hlstd{TMAX.gls} \hlkwb{=} \hlkwd{gls}\hlstd{(TMAX} \hlopt{~} \hlstd{NewDate,} \hlkwc{data} \hlstd{= Thailand,} \hlkwc{na.action}\hlstd{=na.omit)}
\hlkwd{summary}\hlstd{(TMAX.gls)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{TMAX.gls2} \hlkwb{=} \hlkwd{gls}\hlstd{(TMAX} \hlopt{~} \hlstd{NewDate,} \hlkwc{data} \hlstd{= Thailand,} \hlkwc{correlation} \hlstd{=} \hlkwd{corAR1}\hlstd{(}\hlkwc{form}\hlstd{=}\hlopt{~}\hlnum{1}\hlstd{),} \hlkwc{na.action}\hlstd{=na.omit)}
\hlkwd{summary}\hlstd{(TMAX.gls2)}
\end{alltt}
\begin{verbatim}
## Generalized least squares fit by REML
##   Model: TMAX ~ NewDate 
