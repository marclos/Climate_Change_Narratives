...
NOTE: I am not a statitian. But I have written this because I have never found an adequate guide for undergraduates that is both accessible and complete enough for our project. However, no document is perfect.
...
\begin{figure}\label{fig:tree}
\caption{Decision tree for frequents inference depending on the predictor and response data types.}
\begin{center}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(diagram): there is no package called 'diagram'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}openplotmat"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}coordinates"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: could not find function "{}straightarrow"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}textellipse"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}textrect"{}}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[2, 1] + 0.05, arrpos[2, 2], "{}yes"{}): plot.new has not been called yet}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[3, 1] - 0.05, arrpos[3, 2], "{}no"{}): plot.new has not been called yet}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[4, 1] + 0.05, arrpos[4, 2] + 0.05, "{}yes"{}): plot.new has not been called yet}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[5, 1] - 0.05, arrpos[5, 2] + 0.05, "{}no"{}): plot.new has not been called yet}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[6, 1] + 0.05, arrpos[4, 2] + 0.05, "{}yes"{}): plot.new has not been called yet}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in text.default(arrpos[7, 1] - 0.05, arrpos[5, 2] + 0.05, "{}no"{}): plot.new has not been called yet}}\end{kframe}
\end{knitrout}
...
\subsection{Creating Monthly Averages}
...
\begin{alltt}
\hlcom{#Get months}
\hlcom{#Thailand$Month = months(LosAngeles$NewDate) # Creates problems.}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{MonthlyMean} \hlkwb{=} \hlkwd{aggregate}\hlstd{(TMAX} \hlopt{~} \hlstd{Month} \hlopt{+} \hlstd{Year, Thailand, mean)}

\hlstd{MonthlyMean}\hlopt{$}\hlstd{YEAR} \hlkwb{=} \hlkwd{as.numeric}\hlstd{(MonthlyMean}\hlopt{$}\hlstd{Year)}
\hlstd{MonthlyMean}\hlopt{$}\hlstd{MONTH} \hlkwb{=} \hlkwd{as.numeric}\hlstd{(MonthlyMean}\hlopt{$}\hlstd{Month)}


\hlstd{MonthlySD} \hlkwb{=} \hlkwd{aggregate}\hlstd{(TMAX} \hlopt{~} \hlstd{Month} \hlopt{+} \hlstd{Year, Thailand, sd)}

\hlstd{MonthlySD}\hlopt{$}\hlstd{YEAR} \hlkwb{=} \hlkwd{as.numeric}\hlstd{(MonthlySD}\hlopt{$}\hlstd{Year)}
\hlstd{MonthlySD}\hlopt{$}\hlstd{MONTH} \hlkwb{=} \hlkwd{as.numeric}\hlstd{(MonthlySD}\hlopt{$}\hlstd{Month)}
\hlstd{MonthlySD}\hlopt{$}\hlstd{NewDate} \hlkwb{=} \hlstd{MonthlySD}\hlopt{$}\hlstd{YEAR} \hlopt{+} \hlstd{(MonthlySD}\hlopt{$}\hlstd{MONTH} \hlopt{-} \hlnum{1}\hlstd{)}\hlopt{/}\hlnum{12}

\hlkwd{head}\hlstd{(MonthlySD)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(MonthlyMean}\hlopt{$}\hlstd{TMAX,} \hlkwc{ty}\hlstd{=}\hlstr{'l'}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(MonthlyMean}\hlopt{$}\hlstd{TMAX[MonthlyMean}\hlopt{$}\hlstd{Month}\hlopt{==}\hlstr{"05"}\hlstd{],} \hlkwc{ty}\hlstd{=}\hlstr{'l'}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/unnamed-chunk-21-1} 
\begin{kframe}\begin{alltt}
\hlkwd{plot}\hlstd{(TMAX}\hlopt{~}\hlstd{YEAR,} \hlkwc{data}\hlstd{=MonthlyMean[MonthlyMean}\hlopt{$}\hlstd{Month}\hlopt{==}\hlstr{"05"}\hlstd{,],} \hlkwc{ty}\hlstd{=}\hlstr{'l'}\hlstd{)}
\hlstd{May.lm} \hlkwb{<-} \hlkwd{lm}\hlstd{(TMAX}\hlopt{~}\hlstd{YEAR,} \hlkwc{data}\hlstd{=MonthlyMean[MonthlyMean}\hlopt{$}\hlstd{Month}\hlopt{==}\hlstr{"05"}\hlstd{,])}
