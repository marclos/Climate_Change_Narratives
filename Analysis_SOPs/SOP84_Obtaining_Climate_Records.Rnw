...
Once you get the data, we'll need to evaluate what we have and format it for our purposes.
...
<<>>=
ncdc_locs(locationcategoryid='CITY', sortfield='name', sortorder='desc', token = 'qZqZPeprQLtooYJMiFzCEqqaNMdGJRgb')
@

\subsubsection{Getting Data}
<<>>=
ncdc_stations(datasetid='GHCND', locationid='FIPS:12017', stationid='GHCND:USC00084289', token = 'qZqZPeprQLtooYJMiFzCEqqaNMdGJRgb')
@
