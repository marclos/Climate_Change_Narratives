...
Note: if you are getting an error saying: error in plot.window(need finite 'ylim' values), you may need to check whether the months in your data set have a 0 infront of them or not. If not, try "5" instead of "05".
