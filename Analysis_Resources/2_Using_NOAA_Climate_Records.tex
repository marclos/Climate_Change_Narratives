...
\hlcom{# I don't know why I can't the code "%m/%d/%19y" to work... }

\hlcom{#so I had to hack something lame...}
...
\hlkwd{as.Date}\hlstd{(strDates,} \hlkwc{format}\hlstd{=}\hlstr{"%Y-%m-%d"}\hlstd{)[}\hlnum{1}\hlopt{:}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
