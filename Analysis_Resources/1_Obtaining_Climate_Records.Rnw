...
#"/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Data/FA19/ersst.v5.185401.nc")

# Attempts to instlal have been met with frustration...
# R CMD INSTALL ncdf4_1.9.tar.gz?
  
# sudo apt install netcdf-*
#  R CMD INSTALL --configure-args="--with-nc-config=/home/github/Climate_Change_Narratives/nc-config" ncdf4
@
