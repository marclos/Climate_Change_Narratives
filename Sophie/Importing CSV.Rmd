...
file = "/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Sophie/NewOrleansNOAAdata.csv"
...
Dec.lm <- lm(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="July",])
summary(July.lm)
...
November.lm <- lm(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="November",])
summary(November.lm)
