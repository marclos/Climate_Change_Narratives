...
#summary(Ewa.lm)
plot(TMAX~NewDate, Ewa, ty='l', xlab = "Year", ylab = "Temperature (Fahrenheit)", las = 1, main = "Mean Maximum Temperatures Over Time")
...
#summary(EwaMax.lm)
plot(TMAX~NewDate, Ewa[Ewa$DATE< 19780101,], ty='l', xlab="Year", ylab="Temperature (Fahrenheit)", las =1, main = "Mean Maximum Temperatures Over Time")
...
#summary(EwaMin.lm)
plot(TMIN~NewDate, Ewa[Ewa$DATE< 19780101,], ty='l', xlab="Year", ylab="Temperature (Fahrenheit)", las = 1, main = "Mean Minimum Temperatures Over Time", pch = 20)
