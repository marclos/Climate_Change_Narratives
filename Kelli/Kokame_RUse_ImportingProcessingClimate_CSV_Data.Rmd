...
file = "/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Data/Kokame.csv"
...
```{r}
LosAngeles <- subset(import, STATION_NAME=="EWA PLANTATION 741 HI US", select=c(STATION, STATION_NAME, DATE, NewDate, TMIN, TMAX, PRCP))
```
