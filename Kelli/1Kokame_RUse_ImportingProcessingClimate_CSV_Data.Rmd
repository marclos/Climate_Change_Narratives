...
Now, let us analyze the trend of the maxmimum temperature data.  
```{r}
# Linear Model
...
As you can see, minimum temperatures also have an upward trend, with a slope of roughly 5.8e-05. 
...
Though the trend line is not very steep, any change has to be considered over long periods of time. If the temperature follow along this same trend for a longer period of time, the temperature could then increase significant amounts. Also, this data unfortunately does not include data from the most recent years, so it could be missing trends in temperature caused by increases in carbon dioxide levels since 2006. If the station had included readings from 2015 and onward,    
