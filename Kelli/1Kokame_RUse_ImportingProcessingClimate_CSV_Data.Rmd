...
plot(MonthlyMeanTMIN$TMIN[MonthlyMeanTMIN$Month=="7"], ty='l')

plot(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="7",], ty='l') 
July.lm <- lm(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="7",])
summary(July.lm)
