...
These will be either a ftp or http site. Copy the URL into a clipboard.
...
For example, using the NOAA's website, I found the following URL, \url{ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily/all/}, to download data from the Global Historical Climatalogical Network (GHCDN). The site can stall, so we should probably find a more reliable site.
