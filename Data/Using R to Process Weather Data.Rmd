...
There are a number of resources to help us (beside this document!)
...
For example, using the NOAA's website, I found the following URL, ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily/, to download data from the Global Historical Climatalogical Network (GHCDN).

These will be either a ftp or http site. Copy the URL into a clipboard and then create a object with the link:
...
Alternatively, you could choose to download the entire dataset, which I have done already -- and this is how:
