...
For example, using the NOAA's website, I found the following URL, \url{ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily/}, to download data from the Global Historical Climatalogical Network (GHCDN).
