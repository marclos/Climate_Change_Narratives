...
```{r}
plot(TMAX~DATE, import[import$DATE<19300102,], ty='l')
```
...
```
Now, the change is `r coef(June.lm)[2]` degress/year or `r round(coef(June.lm)[2]*100, 3)` degress/100 years (YIKES!) with a probability of `r round(summary(June.lm)$coefficients[2,4],4)`. Although we can't reject the null hypothesis, it is worrying!
