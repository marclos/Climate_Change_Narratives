...
Slope= c(" Slope ",-3.86, -3.62, -2.02, -3.8, -1.92, -1.70, -1.36, -1.91, -1.38, .31, -.1, -.29) 
Pvalue= c(" P-value ","<.01",.01,.09, "<.01",.02,.049,.02,"<.01",.02,.69,.92,.82) 
Month=c(" Month ","January","February","March","April","May","June","July","August","September","October","November","December")
df = data.frame(Month, Slope, Pvalue)       # df is a data frame

library(xtable)

print(xtable(df),type="html",include.rownames=FALSE, columnnames=FALSE)
```
