...
\end{quote}
From its introduction, this report seems to focus on physical elements of the region.
...
\begin{itemize}
  \item Implications of this change on population—ie agriculture, public health
...
Wisconsin, the Office of the Press Secretary noted in 2014 that, ““In the next few decades, longer growing seasons and rising carbon dioxide levels will increase yields of some crops… in the long term, the combined stresses associated with climate change are expected to decrease agricultural productivity” (Office of the Press Secretary, 2014). 
...
