...
If there is a visible trend in the graph, a regression line (or best-fit line) will then be generated and analyzed to find a P-value. P-values are used to test statistical significance in a hypothesis test. It determines how our data supports the null hypothesis being true. The null hypothesis assumes no effect, or in this case no clear evidence that climate change has occurred. To clarify: 
