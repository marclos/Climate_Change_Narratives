...
Logical fallacies: cannot assume that all climate changes are the same / equalized everywhere in the world. Acknowledge that this is a hasty generalization. 
Null hypothesis : because probability is less than 0.05, we have to say that there isnt a trend. Trend line is too vague. 
