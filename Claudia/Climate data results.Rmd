...
Dec.lm <- lm(TMAX~YEAR, data=MonthlyMean[MonthlyMean$Month=="11",])
summary(Dec.lm)
...
Dec.lm <- lm(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="05",])
summary(Dec.lm)
