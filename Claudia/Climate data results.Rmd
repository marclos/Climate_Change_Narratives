...
plot(TAVG~ NewDate, import, ty='l')
TAVG.lm <- lm(TAVG~NewDate, import)
summary(TAVG.lm)
...
May.lm <- lm(TMAX~YEAR, data=MonthlyMean[MonthlyMean$Month=="12",])
summary(May.lm)
...
# Monthly Mean Minimum Temperature - August
```{r}
plot(MonthlyMeanTMIN$TMIN, ty='l')

plot(MonthlyMeanTMIN$TMIN[MonthlyMeanTMIN$Month=="8"], ty='l')

plot(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="8",], ty='l') 
Dec.lm <- lm(TMIN~YEAR, data=MonthlyMeanTMIN[MonthlyMeanTMIN$Month=="12",])
summary(Dec.lm)
...
# Monthly Mean Maximum Temperature - November
...
abline(coef(November.lm), col="yellow")
```
