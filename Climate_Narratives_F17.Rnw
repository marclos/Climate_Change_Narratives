...
studentA = c("Kirara","Ally", "Caroline", "Brooke","Meily", "Valentina", "Bebe")
#studentB = c("Caroline", "Kihara", "Sarah", "Chris", "Katherine", "Valentina")
presentDate =c("09/18/17", "09/18/17", "09/18/17", "NA", "09/18/17", "09/20/17", "09/20/17")
project1teams <- data.frame(Topic = team, Student = studentA, Presentation_Date=presentDate)
...
reviewed1 = c("11790", "", "61296",     "NA",   "91789",  "66354", "98159")
reviewed2 =c("66354", "NA", "98159",      "NA",   "11790",  "61296",    "91789")
peerreview <- data.frame(Reviewer = reviewer, To_be_reviewed=reviewed1, To_be_reviewed=reviewed2)
print(xtable(peerreview), include.rownames=FALSE)
@
