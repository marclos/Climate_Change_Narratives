...
```{r SRace, echo=FALSE, eval=FALSE, fig.width=7,fig.height=6,fig.cap="* = admission data < 11"}
...
barplot(t(SRace), names.arg=SRace$Date, col=colfunc(2), ylim=c(0, 150), las=1)
legend("top", inset = 0.00, c("White", "Hispanic"),  fill=colfunc(2), horiz=TRUE, cex=1.1, box.lty=0) 
```
...
```{r SAge, echo=FALSE, eval=F, fig.width=7,fig.height=6,fig.cap="* = admission data < 11"}
...
```{r SRes, echo=FALSE, eval=F, fig.width=7,fig.height=6,fig.cap="* = admission data < 11"}
