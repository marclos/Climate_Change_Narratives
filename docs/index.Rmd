...
In contrast to the red herring nature of political debates about the role of greenhouse gases on climate change, we know how they influence the planet's climate from multiple sources of evidence [@pachauri2015ipcc]. Furthermore, as a major greenhouse gas, carbon dioxide (CO<sub>2</sub>) concentrations are increasing as a result of our use of fossil fuels and already influences the planet's climate.
...
Once completing the analysis of a station, we evaluated the scientific literature on the implications of climate change relevent to the region in question. 
