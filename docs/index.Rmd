...
The concept of climate justics has taken on a wide range of ethical frameworks which have been applied to diverse set of political and social scales. Within the nation-state governance anarchy, scholars have attempted to create moral imperatives to address climate impacts on countries that have not contributed to or enjoyed the economic rewards of greenhouse gases emissions. [Bekkers (2019)](F2019/Bekkers/Bekkers2.html) using an ethical framework to argue that the Netherlands should provide assistance to the Marshall Islands as the islands face potentially devastating impacts of sea level rise. 
