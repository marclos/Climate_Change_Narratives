...
In early March 2017, the recently confirmed administrator of the US Environmental Protection Agency, Scott Pruitt reaffirmed his disbelief that carbon dioxide is a major contributor to climate change. Citing the challenge of "measuring with precision human activity on the climate" and "tremendous disagreement", Pruitt's comment is unsurprising. Nevertheless, we wonder, 'what are the implications of Pruitt's views for Americans?'
