...
```{r echo=FALSE, fig.margin = TRUE, out.width='100%', fig.cap='Strategies to address natural disasters vary, while some may have some limited political value, there are many who are effective and thoughtful about providing support to victims.'}
