...
```
For example, starting in 1881 a station in China has been recording daily temperatures, but it is not clear 1) where the station is, 2) who has been in charge of it, 3) what technology there were using to make their measurements [Massari (2019)](F2019/Massari/Massari2.html).

Meanwhile weather stations in remote locations, such as Glacier National Park have been moved so often, that developing a long-term trend might seem impossible [Foster (2019)](F2019/Foster/Foster2.html).
...
[Saravia (2019)](F2019/Saravia/Saravia0.html)[DOESN'T SEEM TO BE DONE] was interested in the alpine impacts, especially with respect to the skiing season and found a dramatic decline in snow cover late spring. 

```{r echo=FALSE, fig.margin = TRUE, out.width='100%', fig.cap='Skiers between the 1920s and 1930s'}
knitr::include_graphics('F2019/Skiers from between 1920s-30s.jpg')
```
...
As it turns out obtaining and processing the data from NOAA is far from trivial. To make the process more transparent, [Hsu (2019)](F2019/Hsu/Hsu1.html) documented the steps taken to determine if trends exist in San Francisco. In this example, we can see the messy process of learning to analyze these data.

In addition, some data have biases -- but bias does not need worthless -- instead scientists work hard to remove the impacts of bias as pointed out by [Piette (2019)](F2019/Piette/Piette2.html) while analyzing Seattle's long term trends.

The temperature trend, however, are not always easy to digest. For example, [Grant (2019)](F2019/Grant/Grant1.html) found minimum temperature trends in Chicago are rising at a faster rate than maximum temperature trends in the area, indicating that Chicagoans will likely endure hotter days and nights with little relief, in the future.

## Impacts and Coastal Zone Impacts

Nevertheless, for coastal zones, the impacts of climate change might be ``felt'' in a myriad of ways, for example, sea level rise in San Francisco [(Hsu 2019)](F2019/Hsu/Hsu1.html) and Seattle [(Piette 2019)](F2019/Piette/Piette2.html) will require a dramatic investment to limit the impacts of floods, protect infrastructure, and maintain economic activities.

## SST

[Weed (2019)](F2019/Weed/Weed0.html)[NOT DONE YET]



## Perceptions and Records

In the climate change debate, as in many conflicts, we find that our beliefs, ideals and political affiliations play a distinct role in our perceptions. This blog explores how belief for or against climate change filters public perception in different regions. For example, [Whitman_Sandmeyer (2019)](F2019/Whitman_Sandmeyer/Whitman_Sandmeyer2.html) found that the signal for climate change in Kentucky to be challenging to determine. This, of course, ``maps'' onto the region in particularly interesting ways in terms of politics and climate impacts.  
...
knitr::include_graphics('F2019/Risk_Perception.jpg')
```
