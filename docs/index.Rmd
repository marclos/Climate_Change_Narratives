...
As it turns out obtaining and processing the data from NOAA is far from trivial. To make the process more transparent, [Hsu (2019)](F2019/Hsu1.html) documented the steps taken to determine if trends exist in San Francisco. In this example, we can see the messy process of learning to analyze these data.
