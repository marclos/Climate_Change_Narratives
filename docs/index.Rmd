...
```{r echo=FALSE, fig.margin = TRUE, out.width='100%', fig.cap='2015 Flood in Fenton, Missouri. Human developments in the flood plain is a recipe for disaster. But do the hazards of these activities increase in frequency or intensity with climate change? This is a question that "attribution science" tries to answer.'}
