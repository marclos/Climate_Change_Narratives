...
Fuel management techniques are important in California to reduce the impact of wildfires in
various counties. These techniques vary among counties in northern and southern California
due to differences in climate such as temperature, soil moisture, and vegetation difference.
Patterns of land use also determine what types of management to use. In residential areas,
prescribed fires are not suggested because it puts the residents at risk of property loss and
death. Therefore, prescribed fires are more used in less populated counties with a high amount
of brush. These counties tend to see a larger amount of smaller fires, and less large fires.
Ultimately, fires are less likely to return in a county that uses prescribed fires. In more populated
counties, laws and regulations are used to prohibit activities that may provoke wildfires, such as
pollution, close-proximity land development, and regulating the amount of resources used at a
time.


As summarized by [Scanlon (2018)](F2018_Blogs/Scanlon.html), a combination of prescribed fire and mechanical thinning may be the most effective way to reduce the fuel load in the years following the managament technique.
