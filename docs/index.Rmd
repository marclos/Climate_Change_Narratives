...
lines(loess~decimal.date, data=maunaloa, lwd=2, col="red")
...
Climate change has specific and differential impacts on health outcomes and in many case, fall disporportionately on vulnerable populations. 


 [Greene (2020)](F2020/Greene.html) follows a similar thread for Washington D.C. where...something interesting to say... In contrast, [Tahbaz (2020)](F2020/Tahbaz.html) evaluates the non-intuitive impact of snow events in NYC and it's social justice implications. 
