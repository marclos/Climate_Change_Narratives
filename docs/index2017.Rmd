...
Pruitt's argument might stem from a criticism that scientist are lemmings and willing to do research to support specific finacial incentives (funding sources with particular goals). That scientists are willing to sacrafice their scientific integrity to pursue these funding opportunities (so they can be rewarded, e.g. money to the universities, and publicatiosn for promotion...). 
