...
First, what EPA panels is Pruitt refering to? I was able to find 13 advsisor panels: 
...
Part of the scientific project is to create reliable information that is generated with transparency. In spite of the technical language, our goal describes science in a way that people understand it's goals and methods.
...
Without a doubt, one of the most probablematic areas for scientists is to figure out how to place their research in "broader impacts", a category used by the National Science Foundation for evaluating research grants, and remain within the solid footing of scientifically based conclusions. Nevertheless, this goal allows us to glean the projected societal impacts of the research conclusions. 

As a class, we have been cognizant of extrapolating beyond the science and making sure we are explicit when making normative statements that might be beyond normal scientific conclusions. So, for these blogs, we have been explicit about linking the science to social and ethical concerns to put the science in context.



## Fall 2017 Blogs and Op Ed

[Torrance, CA by Allison Joseph](F2017_Blogs/Joseph_blog_1700g.html)

-[TitleofOpED](Some link...)

[Santa Monica, Bebe Phornprapha](F2017_Blogs/phornprapha-blog-171009.html)

[Sugar Land, TX by Kirara Tsutsui](F2017_Blogs/Tsutsui_Blog_17_10_9.html)
