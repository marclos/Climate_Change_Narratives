...
```{r, echo=FALSE}
##Read CSV Data
climate_data <- read.csv("/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/docs/S2019_Blogs/Budd/susannah_concordnh_data.csv")
```
...
leaf_observations <- read.csv("/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/docs/S2019_Blogs/Budd/Leaf-Chart-1-1.csv")
```
