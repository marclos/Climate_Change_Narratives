...
```{r, echo=FALSE, out.width='70%'}
   knitr::include_graphics('../png/GSOM-Arizona.png')
```
...
Arizona has not developed a statewide adaptation plan (Source: Georgetown Climate Center)https://www.georgetownclimate.org/adaptation/state-information/arizona/overview.html
