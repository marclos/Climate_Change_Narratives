...
plot(TMAX~Year,data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="01",],
     ty="l", xlim=c(1910,2020), main="Maximum Temperatures in January in De Bilt, Netherlands", xlab="Year", ylab="Maximum Temperatures (°)")
...
plot(TMIN~NewDate, climate_data, ty='l', main="Minimum Temperatures between 1901 and 2019 in De Bilt, Netherlands",xlab="Year", ylab="Minimum Temperature (°)")
...
plot(TMIN~Year,data=MonthlyTMINMean[MonthlyTMINMean$Month=="01",],
     ty="l", xlim=c(1910,2020), main="Minimum Temperatures in January", xlab="Year", ylab= "Minimum Temperatures (°)")
...
plot(TMIN~Year,data=MonthlyTMINMean[MonthlyTMINMean$Month=="08",],
     ty="l", xlim=c(1910,2020), main="Minimum Temperatures in August", xlab="Year", ylab="Minimum Temperatures (°)")
...
plot(TMAX~Year,data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="08",],
     ty="l", xlim=c(1910,2020), main="Maximum Temperatures in August", xlab="Year", ylab="Maximum Temperatures (°)")
...
```{r}
plot(PRCP~Year,data=MonthlyPRCPMean[MonthlyPRCPMean$Month=="12",],
     ty="l", xlim=c(1910,2020), main="Precipitation in December", xlab="Year", ylab="Precipitation (mm)")
BestfitPRCPdec<-lm(PRCP~Year,data=MonthlyPRCPMean[MonthlyPRCPMean$Month=="12",])
summary(BestfitPRCPdec)
summary(BestfitPRCPdec)
abline(BestfitPRCPdec, col="blue")
```
```{r}
plot(PRCP~Year,data=MonthlyPRCPMean[MonthlyPRCPMean$Month=="05",],
     ty="l", xlim=c(1910,2020), main="Precipitation in May", xlab="Year", ylab="Precipitation (mm)")
BestfitPRCPmay<-lm(PRCP~Year,data=MonthlyPRCPMean[MonthlyPRCPMean$Month=="05",])
summary(BestfitPRCPmay)
