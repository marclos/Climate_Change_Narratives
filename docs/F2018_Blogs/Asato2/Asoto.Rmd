...
barplot(t(SRace1), names.arg=SRace$Date, col=colfunc(2), ylim=c(0, 150), las=1)
legend("top", inset = 0.00, c("White", "Hispanic"),  fill=colfunc(2), horiz=TRUE, cex=1.1, box.lty=0) 
```
...
barplot(t(SAge1.data), names.arg = SAge$Admission_Date, col = colfunc(4), ylim =c(0, 250), las=1)
text(0, 100, "*")
text(1,100,"*")
text(2, 100, "*")
text(3,100,"*")
...
barplot(t(SRes1.data), names.arg = SRes$Admission.Date, col = colfunc(1), xlim = c(0,70), ylim = c(0,25), las=1)
text(0, 10, "*")
text(1, 10, "*")
text(2, 10, "*")
text(3, 10, "*")
