...
```{r TCRace, echo=FALSE}
import=read.csv("/home/CAMPUS/mbah2016/Daily ED Admits 10-15-2007 to 11-20-2007, Select Facilities .csv")
race.data = matrix(c(import$White, import$Hispanic), nrow=length(import$White))
barplot(t(race.data))
```
...
```{r TCAge, echo=FALSE}
age=read.csv("/home/CAMPUS/mbah2016/TC_Age.csv")
...
```{r TCRes, echo=FALSE}
TCres=read.csv("/home/CAMPUS/mbah2016/TC_Res.csv")
...
```{r SRace, echo=FALSE}
SRace=read.csv("/home/CAMPUS/mbah2016/SRace.csv")
...
```{r Sage, echo=FALSE}
SAge=read.csv("/home/CAMPUS/mbah2016/SAge.csv")
...
```{r SRes, echo=FALSE}
SRes=read.csv("/home/CAMPUS/mbah2016/SRes.csv")
