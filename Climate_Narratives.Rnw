...
\subsection{Session X: How are temperature data collected?}
...
Note: \href{https://net.educause.edu/ir/library/pdf/ELI7004.pdf}{7 Things to know about Wikis}
\subsubsection{Evaluation Criteria}

Evaluation criteria will be proposed by an "Expert Team" and inserted in Wiki. 

\subsection{Session X: How are the data store, curated and checked for quality?}
