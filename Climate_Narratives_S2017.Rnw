...
<<echo=F, results = 'asis'>>=
library(xtable)
students = c("Claudia", "Katharine", "Khalil", "Kelli", "Theadorea", "Viraj", "Mireya", "Marisa", "Olivia", "Yuxin")
...
Summary of Literature Review& 10\%            & Feb. 17th \\
Blog                        & 20\%            & Feb. 24th \\
Pre-Op Ed Discussion        & 10\%            & Feb. 27th \\     
Op Ed                       & 20\%            & Mar. 3rd \\
