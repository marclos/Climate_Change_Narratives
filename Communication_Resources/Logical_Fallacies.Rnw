...
Writing in science is purposeful, i.e. that make a point. Learning to make an argument relies on using rhetorical tools. 
It's an effort that takes time -- the art of effective or persuasive speaking or writing, especially the use of figures of 
speech and other compositional techniques.


\subsection{The Good, Bad, and Ugly}

Rhetoric is used to make a point, but it can also use detract or obscure. This is what we are going to be identifying 
in the counter arguments on climate change. 

\subsection{Expertise}

An expert demonstrates great skill or knowledge in a particular field. 

Appealing to experts is a common rhetorical tool and can be a very effective in positive or problematic ways. So, how can we decide?

\subsubsection{Who are reliable experts?}


, but who is a qualified expert? 

\noindent EXAMPLE: 

\subsubsection{Bandwagon}

Bandwagon...just becuase lots of people believe it, does that make it true? On climate change, 
the threads used for and against the case for anthropogenic climate change. It is usually a combination 
of bandwagon and expertise tools: a band of experts. 

\noindent EXAMPLE: Petition of those who do believe that no convincing evidence supports the GHGs will 
lead to catastrophic heating of the planet and may in fact, be better for the the human population. 
\url{http://www.petitionproject.org/signers_by_last_name.php?run=all}. Of course there is of a rhetorical tool, 
that provides some wiggle room by using the word "catastrophic". In this case, many scientists, who believe 
climate change is a serious threat and will have significant and negative impacts might still rise to the 
criteria of catastrophic. 

\noindent

Remember, as Eistein once said, "No amount of experimentation can ever prove me right; a single experiment can prove me wrong."
...
This is abit like correlation and causation condunudrum, but in a more sophisticated way, 
because and event is following aother, we make causeion claims. Certainly, criticism has been lodged
at climate scientists who claim CO2 emissions are increasing temperature. Instead it might be caused
by diffferent mechanisms and climate scientists are mistaking the cause with something that is preceding it by 
accident or unrelated.
