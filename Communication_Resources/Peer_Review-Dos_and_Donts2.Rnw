...
input = read.csv("/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Admin/EA30SP19.csv")
...
str(input)
assignments <- merge(combined, input[,c(3,5)], by.x="Name", by.y="Student")

FirstMiddlename = sub('.*,\\s*', '', assignments$Name)
assignments$Firstname = gsub( " .*$", "", FirstMiddlename)
assignments$Lastname = gsub(",.*$", "", assignments$Name)


#strsplit(as.character(assignments$Name), ",")[[2]][1]

write.csv(ThreeReviewer[,c(1,6:7)], file = "/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Admin/PeerReviewers.csv")
write.csv(assignments, file = "/home/CAMPUS/mwl04747/github/Climate_Change_Narratives/Admin/PeerReviewAssignments.csv")
@
