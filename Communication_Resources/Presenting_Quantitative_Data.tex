...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{TMAXlabel} \hlkwb{<-} \hlstr{"Temperature (°C)"}
...
\includegraphics[width=\maxwidth]{figure/unnamed-chunk-3-1} \caption[Histogram of Maximum Temperatures (\degree C) (Bangkok, Thailand, 1940-2018)]{Histogram of Maximum Temperatures (\degree C) (Bangkok, Thailand, 1940-2018)}\label{fig:unnamed-chunk-3}
\end{figure}
...
\hlstd{TMINlabel} \hlkwb{<-} \hlstr{"Temperature (°C)"}
...
\end{alltt}
\end{kframe}\begin{figure}
\includegraphics[width=\maxwidth]{figure/unnamed-chunk-4-1} \caption[Mean monthly maximum and minimum tempetures (\degree C) ((Bangkok, Thailand, 1940-2018))]{Mean monthly maximum and minimum tempetures (\degree C) ((Bangkok, Thailand, 1940-2018))}\label{fig:unnamed-chunk-4}
\end{figure}
...
\end{alltt}
\end{kframe}\begin{figure}
\includegraphics[width=\maxwidth]{figure/unnamed-chunk-5-1} \caption[Mean monthly maximum and minimum tempetures (\degree C) ((Bangkok, Thailand, 1940-2018))]{Mean monthly maximum and minimum tempetures (\degree C) ((Bangkok, Thailand, 1940-2018)).}\label{fig:unnamed-chunk-5}
\end{figure}
...
\hlkwd{hist}\hlstd{(MonthlyTMINMean}\hlopt{$}\hlstd{TMIN,} \hlkwc{main}\hlstd{=}\hlkwa{NULL}\hlstd{,} \hlkwc{xlab}\hlstd{=TMINlabel,} \hlkwc{ylab}\hlstd{=}\hlkwa{NULL}\hlstd{)}
...
\end{alltt}
\end{kframe}\begin{figure}
\includegraphics[width=\maxwidth]{figure/unnamed-chunk-6-1} \caption[Mean monthly maximum (Panel A) and minimum (Panel B) temperatures (\degree C) (Bangkok, Thailand, 1940-2018)]{Mean monthly maximum (Panel A) and minimum (Panel B) temperatures (\degree C) (Bangkok, Thailand, 1940-2018).  Notice the y-axis is noted once and the y-axis values have been rotated.}\label{fig:unnamed-chunk-6}
\end{figure}
...
The mean was for the first draft was 21.1 and the second draft was 32.9. We can test the null hypothesis that were was no difference between the two scores. Since the difference  between the scores of the first and second submission was 11.8 points, we can reject the null hypothesis that the difference was zero using the t.test() function in R and obtain a p-value of 0.0089. We can also run the test as a pair test, where each student's first score is matched with their second score. This is useful when you have data from the same individuals; in this case the p-value is \ensuremath{3\times 10^{-6}}. However, once the probability is below 0.001, we report it as p < 0.001. 
