...
\hlstd{x} \hlkwb{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{50}\hlstd{,} \hlkwc{by} \hlstd{=} \hlnum{1.35}\hlstd{)}
...
\hlkwd{text}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{.07}\hlstd{,} \hlkwd{paste}\hlstd{(}\hlstr{"p-value = "}\hlstd{,} \hlkwd{round}\hlstd{(ttest}\hlopt{$}\hlstd{p.value,} \hlnum{4}\hlstd{),} \hlstr{"or better p < 0.001"}\hlstd{))}
