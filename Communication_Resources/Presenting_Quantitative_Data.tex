...
\bigskip
BTW: The mean was for the first draft was 21.1 and the second draft was 30. Based on a paired t-test, the difference between the two grades is signficant. 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{),} \hlkwc{las}\hlstd{=}\hlnum{1}\hlstd{)}
...
\hlkwd{plot}\hlstd{(x, hx1,} \hlkwc{type}\hlstd{=}\hlstr{"l"}\hlstd{,} \hlkwc{lty}\hlstd{=}\hlnum{1}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{"Score"}\hlstd{,}
  ...
  \hlkwd{lines}\hlstd{(x, hx3,} \hlkwc{lwd}\hlstd{=}\hlnum{2}\hlstd{,} \hlkwc{col}\hlstd{=colors[}\hlnum{3}\hlstd{])}
...
\hlkwd{text}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{.05}\hlstd{,} \hlkwd{paste}\hlstd{(}\hlstr{"p-value = "}\hlstd{,} \hlkwd{round}\hlstd{(ttest}\hlopt{$}\hlstd{p.value,} \hlnum{4}\hlstd{),} \hlstr{"or better p < 0.001"}\hlstd{))}
