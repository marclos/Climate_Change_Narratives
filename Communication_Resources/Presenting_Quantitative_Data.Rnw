...
<<echo=FALSE>>=
grades = c(22, 34, 22.5, 22.5, 28, 29.5, 36.5, 31.5, 31.5, 2, 31)
library(xtable)
options(xtable.floating = FALSE)
options(xtable.timestamp = "")

bins = cut(grades, seq(0,50,10))
grades_tab = table(cut(grades, breaks = seq(0,50,10)))
#names(grades_tab) <- c("<10", ">= 10-- < 20", ">= 20-- < 30", ">= 30-- < 40", "> 40")
grades.df = data.frame(grades_tab)
names(grades.df) = c("Range", "Frequency")
...
\bigskip
<<fig.cap="Histogram of First Blog Draft Scores", fig.height=3, fig.width=3 >>=
