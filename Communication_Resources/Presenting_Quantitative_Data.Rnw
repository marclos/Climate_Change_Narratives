...
\bigskip
<<fig.cap="Histogram of First Blog Draft Scores", fig.height=3, fig.width=5 >>=
par(mfrow=c(1,2))
hist(grades1, main="1st Draft", xlab="Score", xlim=c(0,50))
hist(grades2, main="2nd Draft", xlab="Score", xlim=c(0,50))
@
