...
After acquiring Alabama NOAA temperature records from over a 60 year period, I analyzed the climate trends in Huntsville, AL. From this data I observed an increase in maximum temperature, and a decrease in minimum temperature. The graph shows the average temperature trend in the hottest month, July, over a 60 year time period. Ideally we would want to analyze a longer record, which would probably show a stronger trend, but a 60 year timeframe is about what most humans today might be able to remember. The trend I observed in maximum temperatures was not statistically signficant, and if shown to Alabamians it probably wouldn't raise any concerns. 

![Figure 2: Average max temperatures recorded in July from 1958 to 2019 in Huntsville, AL (slope: 0.0128 degree/year; p = 0.263)](Max.png)

It's also important to note that NOAA suggests that the south is one of the few places in the U.S. that has not seen significant changes in temperatures (Figure 4). 
...
Based off of these data, it makes sense why southerners may object to climate change or simply not care about it. If it doesn’t affect them, should they care? Well, it does affect them. The southern United States appears to be one of the few regions in the U.S. that is actually cooling in some localized areas. 
