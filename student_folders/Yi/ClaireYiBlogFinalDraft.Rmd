---
title: "How does the Urban Heat Island(UHI) Effect impact selected neighborhoods in Chicago and Surrounding Municipalities?"
author: "ClaireYi"
date: "3/1/2019"
...
<div class="a">
```{r annualminbarrington_plot, echo=FALSE}
...
<div class="a">
```{r annualminparkforest_plot, echo=FALSE}
...
<div class="a">
```{r annualminmidway_plot, echo=FALSE}
...
<div class="a">
```{r julybarrington_plot, echo=FALSE}
climate_data<-read.csv( "/home/CAMPUS/syaa2016/Climate_Change_Narratives/student_folders/Yi/claireyi_climatedata_chicago.csv")
strDates <- as.character(climate_data$DATE)
...
<div class="a">
```{r julyparkforest_plot, echo=FALSE}
climate_data1<-read.csv("/home/CAMPUS/syaa2016/Climate_Change_Narratives/student_folders/Yi/ParkForest_climatedata_claireyi.csv")
strDates <- as.character(climate_data1$DATE)
