...
```
```{r tmaxmonthofjune}
plot(MonthlyTMAX ~ YEAR, MonthlyTMAX[MonthlyTMAX$Month=="06",], climate_data, ty='l')
```
## R Markdown
...
plot(TDIF~YEAR, data=MonthlyTMAXMean[MonthlyTMAXMean$Month=="06",],
ty='l', xlim=c(1950, 2020))
```
