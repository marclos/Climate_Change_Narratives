...
plot(airtemp_max~date, D1_daily_temp, main="Figure 5. Daily Max Temp at D-1 Station", ylab = "Daily Max Temperature (°C)", ty='l')
abline(lm(airtemp_max ~ date, data=D1_daily_temp), col="red")
plot(pppt_tot~date, main="Figure 6. Daily Precipitation at D-1 Station", ylab = "Daily Precipitation Total", D1_daily_precip, ty='l')
