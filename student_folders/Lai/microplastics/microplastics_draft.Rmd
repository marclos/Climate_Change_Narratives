---
title: "Comparing Microplastic Pollution in Romaine Lettuce Sold With or Without Plastic Packaging"
author: "bljj2015"
date: "4/22/2019"
output: 
...
```{r q-q plot figure out how it works, do I need to have all the samples of bagged/unbagged in one row??}
qqplot(avg_BG_UB$Unbagged)
```
...
_**Table 1.** Test of differences between bagged and unbagged microplastic counts paired with each store_
