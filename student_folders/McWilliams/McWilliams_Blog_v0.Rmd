...
The precipitation data shows a decrease in average rainfall for the month of October in Claremont from 1950 to 1980. There was no data from this weather station after 1980, however, the extended drought from  in the trend continued to decrease .

# Discussion 
 

Compounding factors include: drought, decades of not allowing wildfires to burn brush.
*  In addition, wildfires alter the character of the ecosystems that support them (Westerling 2011).
* “Wildlands are getting burned too often, and then are stressed by drought, causing lasting changes to California’s ecology that make the state even more at risk for wildfires.” (times)
* Who is it affecting? Wildlife and… rich people?
