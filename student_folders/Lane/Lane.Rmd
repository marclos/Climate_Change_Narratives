...
Background:
```{r}
#![Courtesy NASA]("/home/CAMPUS/xmle2015/Climate_Change_Narratives/student_folders/Lane/nola.png")
```
...
Greater Context:
```{r}
#![Courtesy: EPA]("/home/CAMPUS/xmle2015/Climate_Change_Narratives/student_folders/Lane/nola sw.png")
```
...
```{r}
#![Courtesy: U.S. Global Climate Change Research Program]("/home/CAMPUS/xmle2015/Climate_Change_Narratives/student_folders/Lane/nola seasons.png")
```
...
```{r}
#![Courtesy: Dickson 1976]("/home/CAMPUS/xmle2015/Climate_Change_Narratives/student_folders/Lane/new orleans temp map.png")
```
...
```{r}
#![Courtesy: EPA “The number of days reaching temperatures over 95°F in the Southeast is projected to increase during this century. This graph compares historic patterns from 1971-2000 to future estimates for 2041-2070 under a scenario with high greenhouse gas emissions. Adapted from: USGCRP (2014)”]("/home/CAMPUS/xmle2015/Climate_Change_Narratives/student_folders/Lane/historical climatenola.png")
```
