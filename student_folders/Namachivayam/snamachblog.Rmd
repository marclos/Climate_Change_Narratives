...
To begin, I hypothesized that rising temperatures during the summer contributed to the severity of drought in New Mexico. In order to reduce the scope of my analysis, I decided to strictly look at temperature trends within the city of Albuquerque. The station at Albuquerque International Airport provided all the raw data analyzed and presented in the section below.
...
In all of the above graphs for Albuquerque minimum temperatures, each best fit line had p-values less than 0.05. This means our positive trend lines fit the data really well! Hence, we have strong evidence that the monthly averages for Albuquerque minimum temperatures have been increasing since 1931 *for all 12 months* (not only during the summer as I had initially hypothesized). 
...
**1) Mountain snowpack-** Discharge in the Rio Grande river, a crucial source for New Mexico's water supply, directly relates to snowpack in the Jemez Mountains. Temperatures in the Jemez Mountains will be lower than those measured at Albuquerque due to higher altitudes. However, the *trend* of those temperatures will be increasing similar to what we saw in the Albuquerque data, i.e. we can expect the mountains to be warming. Warmer winter temperatures in the mountains will cause more precipation to fall in the form of rain rather than snow, decreasing the total amount of snowfall. In addition, warmer spring temperatures will melt snowpack earlier, ultimately extending the duration and intensity of summer drought.  
...
**2) Evapotranspiration-** Evapotranspiration is the combined effect of evaporation (when liquid turns to vapor) and transpiration (when plants release vapor through the stomata on their leaves). Higher temperatures in regions with trends similar to Albuquerque cause more liquid water to convert to gas and encourage plants to open up their stomata, increasing evapotranspiration. Since increasing evapotranspiration decreases the amount of water available for allocation by transferring vapor into the atmosphere, we can expect the severity of drought conditions to intensify across New Mexico. 

As a brief side note, increased transpiration in New Mexico is slightly mitigated by the presence of drought-resilient plants in the desert. However, the overall trend of diminishing water resources ends up staying about the same. 
...
Warmer temperatures across New Mexico increase the frequency, intensity, and duration of the impacts of drought. These increasingly severe conditions have major consequences for both farmers and agriculture in New Mexico. Due to reduced water allocations, farmers become more dependent on ground water for crop irrigation. As ground water wells become deeper over time, the water from these wells contain higher amounts of salt, damaging crop produdction and threatening the livelihood of farmers throughout the state. 

<div class="a">
```{r picture5, echo=FALSE, fig.cap="Location of Santo Domingo Pueblo between Albuquerque and Santa Fe", out.width = '50%'}
knitr::include_graphics("kwp.png")
```
</div> 

In addition, droughts also come with a whole host of environmental justice issues that exacerbate inequality. For example, one study in California indicates that domestic water supply shortages and rising water costs affect low-income families and people of color the most. Decreasing the affordability of water during shortages increases the precarity of these households' living conditions at a time when they already have little to no disposable income. Indigenous people in New Mexico will also be disproportionately impacted by intensifying drought. In 2014, drought forced the people of the Kewa tribe to give up certain traditional farming practices in order to adapt to changing climate conditions. As the duration and severity of drought increases with warming in New Mexico, more indigenous people will have to fight to maintain their traditions and way of life.
